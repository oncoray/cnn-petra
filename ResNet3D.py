...
'''https://github.com/JihongJu/keras-resnet3d/blob/949a0d2372c1b35824facb2d87bd97f6003afc0f/resnet3d/resnet3d.py#L204'''
...
class Resnet3DBuilder(object):
    ...
    def build(input_shape, num_outputs, block_fn, repetitions, reg_factor):
        ...
        # first conv
        conv1 = _conv_bn_relu3D(filters=64, kernel_size=(3, 3, 3),
                                strides=(2, 2, 2),
...
#                                  strides=(1, 1, 1))(block_output)
        ...
        if num_outputs > 1:
            dense = Dense(units=num_outputs,
                          kernel_initializer="he_normal",
                          activation="softmax",
                          kernel_regularizer=l2(reg_factor))(y)
        else:
            dense = Dense(units=num_outputs,
                          kernel_initializer="he_normal",
                          activation="tanh",
    ...
    @staticmethod
    def resnet_v3(input_shape, num_outputs, reg_factor=1e-4):
        """Build resnet 18."""
